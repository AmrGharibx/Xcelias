...
import { getTraineeJourneyRecommendations } from "@/lib/xcelias-data";
...
export default function TraineeProfilePage() {
        ...
        <div className="flex flex-1 flex-col">
          ...
          <div className="flex-1 overflow-y-auto">
            <div className="mx-auto max-w-7xl px-6 pb-20 pt-8 space-y-6">
              <Breadcrumb items={[{ label: "Command Center", href: "/command-center" }, { label: "Trainees", href: "/trainees" }, { label: "Loading..." }]} />
  ...
  const recommendations = getTraineeJourneyRecommendations({
    attendanceRate: profile.stats.attendanceRate,
    attendanceEligible: profile.stats.attendanceEligible,
    avgAssessmentScore: profile.stats.avgAssessmentScore,
    latestAssessment: latestAssessment
      ? {
          mapping: latestAssessment.mapping,
          productKnowledge: latestAssessment.productKnowledge,
          presentability: latestAssessment.presentability,
          softSkills: latestAssessment.softSkills,
          overallScore: latestAssessment.overallScore,
          outcome: latestAssessment.outcome,
        }
      : null,
  });
  const surfaceIcons = {
              ...
              {activeTab === "overview" && (
                ...
                >
                  ...
                  <PhantomCard className="p-6">
                    <div>
                      <p className="text-[11px] uppercase tracking-[0.22em] text-[#57534e]">Xcelias journey actions</p>
                      <h3 className="mt-2 text-lg font-semibold text-[#fafaf9]">Recommended next moves for this trainee</h3>
                      <p className="mt-2 max-w-2xl text-sm leading-7 text-[#57534e]">
                        These actions use the new Xcelias surfaces to connect live academy signals with remediation, market study, and reporting workflows.
                      </p>
                    </div>
                      ...
                      {recommendations.map((item) => {
                        ...
                        return (
                          <Link
                            ...
                            href={item.href}
                            className="rounded-xl border border-[#a8a29e]/6 bg-[#231f1d]/30 p-4 transition hover:border-emerald-500/20 hover:bg-[#231f1d]/50"
                          >
                            <div className="flex items-start gap-4">
                              ...
                              <div>
                                <p className="font-medium text-[#fafaf9]">{item.title}</p>
                                <p className="mt-2 text-sm leading-7 text-[#57534e]">{item.description}</p>
                              </div>
                            </div>
                          </Link>
                        );
