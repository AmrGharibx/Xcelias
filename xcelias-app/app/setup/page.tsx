      ...
      >
        <div className="obsidian-card p-8">
          <div className="mb-8 text-center">
            ...
            <h1 className="text-2xl font-bold tracking-tight text-white">Welcome to Xcelias</h1>
            <p className="mt-1.5 text-[13px] text-[#57534e]">Create the first administrator account for the unified academy platform</p>
          </div>
